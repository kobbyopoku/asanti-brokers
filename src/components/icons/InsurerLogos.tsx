  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
      {insurerLogos.map(({ name, src }) => (
        <div
          key={name}
          className="bg-white rounded-xl aspect-square flex items-center justify-center p-6 border border-gray-100 hover:border-asanti-green/30 hover:shadow-md transition-all"
        >
          <Image
            src={src}
            alt={name}
